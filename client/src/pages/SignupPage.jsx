    ...
    <div className="min-h-screen flex items-start justify-center mt-28 bg-transparent">
      <div className="bg-slate-800 rounded-lg shadow-md w-96">
        ...
        <form onSubmit={handleRegistration} className="py-3 px-8 font-display">
          <div className="mb-3">
            <label htmlFor="username" className="block text-gray-400 text-sm font-semibold">
              Username
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label htmlFor="password" className="block text-gray-400 text-sm font-semibold">
              Password
            </label>
            <input
              type="password"
          ...
          <button
            className="w-full bg-purple-500 text-white font-semibold py-2 mt-3 rounded-lg transition duration-300 hover:bg-purple-600"
            type="submit">
            Sign Up
          </button>
          {error && <p className="mt-4 text-red-500 text-center">{error}</p>}
        </form>
        <p className="mb-4 text-gray-400 text-center font-display">
