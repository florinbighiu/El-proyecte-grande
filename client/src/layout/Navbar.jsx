...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 text-sm font-medium text-white bg-gray-200">
          ...
          <div className="flex-10 border-b border-slate-900/10 lg:px-8 lg:border-0 dark:border-slate-300/10 mx-4 lg:mx-0">
            {isAuthenticated ? (
              <ul className="flex font-bold font-serif text-base">
                <li className="text-black py-2 px-2 cursor-pointer hover:bg-gray-300 rounded-full">
                  <a href="/" className="px-2">Home</a>
                </li>
                <li className="text-black p-2 px-3 cursor-pointer hover:bg-gray-300 rounded-full">
                  <a href="/products" className="px-2">Products</a>
                </li>
                <li className="text-black p-2 px-3 cursor-pointer hover:bg-gray-300 rounded-full">
                  <a href="/cart" className="px-2">Cart</a>
                </li>
                <li className="text-black p-2 px-3 cursor-pointer hover:bg-gray-300 rounded-full">
                ...
                <li className="text-black hover:text-yellow-500 my-2 pl-8">
                  <a
                    href="/login"
                    onClick={logout}
                    className="text-black border border-indigo-600/50  hover:bg-indigo-600 focus:ring-4 focus:ring-blue-300 font-serif rounded-full px-5 py-2 mr-2 mb-2">
                    Logout
                  </a>
                </li>
              </ul>
              ...
              <ul className="flex font-bold font-serif text-base">
                <li className="text-black hover:text-yellow-500 my-2 pl-4">
                  <a href="/" className="text-black bg-indigo-500  hover:bg-indigo-700 focus:ring-4 focus:ring-blue-300 font-serif text-base rounded-full px-5 py-2 mb-2">Home</a>
                </li>
                <li className="text-black hover:text-yellow-500 my-2 pl-4">
                  <a href="/contact" className="text-black bg-indigo-500  hover:bg-indigo-700 focus:ring-4 focus:ring-blue-300 font-serif text-base rounded-full px-5 py-2 mb-2">Contact</a>
                </li>
                <li className="text-black hover:text-yellow-500 my-2 pl-12">
                  <a
                    href="/login"
                    className="text-black border border-indigo-600/50  hover:bg-indigo-600 focus:ring-4 focus:ring-blue-300 font-serif text-base rounded-full px-5 py-2 mb-2">
                    Log in
                  </a>
                </li>
              </ul>
